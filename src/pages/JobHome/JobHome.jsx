...
import { FaTimesCircle, FaImage, FaEnvelope,FaStar,	FaThumbsUp, FaArrowLeft,FaMoneyBillWave  } from "react-icons/fa";
          ...
          <div className="flex justify-between items-center mb-6 border-b pb-4 border-gray-700 w-full">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex flex-col gap-4 ">
                  <button className={`${isDarkMode ? 'bg-gray-600 hover:bg-gray-700 text-white' : 'bg-gray-300 hover:bg-gray-400 text-gray-800'} w-41 py-2 px-6 rounded-lg shadow-md transition flex items-center gap-2`}>
                    <FaThumbsUp className="text-[15px] text-white-400" />
                    Customer Ok 
                  </button>
                  <button className={`${isDarkMode ? 'bg-gray-600 hover:bg-gray-700 text-white' : 'bg-gray-300 hover:bg-gray-400 text-gray-800'} w-41 py-2 px-6 rounded-lg shadow-md transition flex items-center gap-2`}>
                    <FaStar className="text-[15px] text-white-400" />
                    Approve
                  </button>
              </div>
              <div className="flex flex-col gap-4 ">
                  <button className={`${isDarkMode ? 'bg-gray-600 hover:bg-gray-700 text-white' : 'bg-gray-300 hover:bg-gray-400 text-gray-800'} w-35  py-2 px-6 rounded-lg shadow-md transition flex items-center gap-2`}>
              ...
              <div className="flex flex-col gap-4 ">
                    <button className={`${isDarkMode ? 'bg-gray-600 hover:bg-gray-700 text-white' : 'bg-gray-300 hover:bg-gray-400 text-gray-800'}  w-35  py-2 px-6 rounded-lg shadow-md transition flex items-center gap-2`}>
                                      <FaMoneyBillWave className="text-[15px] text-white-400" />
                                      Payement
                    </button>
                    <Link to="/cancel">
                      <button className={`${isDarkMode ? 'bg-gray-600 hover:bg-gray-700 text-white' : 'bg-gray-300 hover:bg-gray-400 text-gray-800'} w-35  py-2 px-6 rounded-lg shadow-md transition flex items-center gap-2`}>
